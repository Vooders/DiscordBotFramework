...
describe('Bot', () => {
  ...
  describe('stop()', () => {
    verify.it('should destroy the client', () => {
      ...
      const bot = new Bot(config, mockClient)
      bot.stop()
    ...
    verify.it('should log "Stopping bot"', () => {
      ...
      const bot = new Bot(config, mockClient, mockLogger)
      bot.stop()
  ...
  describe('actions', () => {
    describe('getArgs', () => {
      verify.it('should return an array', () => {
        const bot = new Bot(config, StubClient)
  ...
  describe('handleReady', () => {
    verify.it('should log "Bot ready" on start up', () => {
      const mockLogger = td.object(fakeLogger)
      const bot = new Bot(config, StubClient, mockLogger)
